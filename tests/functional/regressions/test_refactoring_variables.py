...
async def ttftt_engine():
    ...
    @Resolver(
        "Query.listBooleanField", schema_name="test_refactoring_variables"
    )
    ...
    @Resolver(
        "Query.listStringField", schema_name="test_refactoring_variables"
    )
    ...
    return await create_engine(_SDL, schema_name="test_refactoring_variables")
...
async def test_refactoring_variables_not_input_type(
...
async def test_refactoring_variables_int(
...
async def test_refactoring_variables_float(
    ttftt_engine, query, variables, expected
):
    assert await ttftt_engine.execute(query, variables=variables) == expected
...
async def test_refactoring_variables_boolean(
    ttftt_engine, query, variables, expected
):
    assert await ttftt_engine.execute(query, variables=variables) == expected
...
async def test_refactoring_variables_string(
    ttftt_engine, query, variables, expected
):
    assert await ttftt_engine.execute(query, variables=variables) == expected
...
async def test_refactoring_variables_enum(
    ttftt_engine, query, variables, expected
):
    assert await ttftt_engine.execute(query, variables=variables) == expected
...
async def test_refactoring_variables_list_int(
    ttftt_engine, query, variables, expected
):
    assert await ttftt_engine.execute(query, variables=variables) == expected
...
async def test_refactoring_variables_list_float(
    ttftt_engine, query, variables, expected
):
    assert await ttftt_engine.execute(query, variables=variables) == expected
...
async def test_refactoring_variables_list_boolean(
    ttftt_engine, query, variables, expected
):
    assert await ttftt_engine.execute(query, variables=variables) == expected
...
async def test_refactoring_variables_list_string(
    ttftt_engine, query, variables, expected
):
    assert await ttftt_engine.execute(query, variables=variables) == expected
...
async def test_refactoring_variables_list_enum(
    ttftt_engine, query, variables, expected
):
    assert await ttftt_engine.execute(query, variables=variables) == expected
...
async def test_refactoring_variables_object(
    ttftt_engine, query, variables, expected
):
    assert await ttftt_engine.execute(query, variables=variables) == expected
...
async def test_refactoring_variables_unknown_enum(
    ttftt_engine, query, variables, expected
):
    assert await ttftt_engine.execute(query, variables=variables) == expected
...
async def test_refactoring_variables_scalar_coerce(
    ttftt_engine, query, variables, expected
):
    assert await ttftt_engine.execute(query, variables=variables) == expected
