        ...
        (
            ...
            None,
            {
                "data": {
                    ...
                    # default value from schema object aren't properly
                    # handled and aren't coerced
                    # when fixed, don't forget to replace the expected value
                    # for this test case
                    # "nonNullListWithDefaultIntField": "SUCCESS-[123459-None]"
                    "nonNullListWithDefaultIntField": "SUCCESS-[123458-None]"
                }
            },
        ),
        (
