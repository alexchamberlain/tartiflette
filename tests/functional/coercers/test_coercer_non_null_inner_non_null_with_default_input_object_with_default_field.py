...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            # default value from schema object aren't properly handled and
            # aren't coerced when fixed, don't forget to replace the expected
            # value for this test case
            # {
            #     "data": {
