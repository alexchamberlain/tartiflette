...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            # {"data": {"nonNullEnumWithDefaultField": "SUCCESS-ENUM_1_1-MyEnum-nonNullEnumWithDefaultField"}},
            {
                "data": {
                    "nonNullEnumWithDefaultField": "SUCCESS-ENUM_1-nonNullEnumWithDefaultField"
                }
            },
        ),
        (
